...
public class TextArchitect
{
    ...
    public string fullTargetText =>preTextLength + targetText;
    ...
    /// <summary>
    /// Append text to what is already in the text architext.將文字附加到文字文件中已有的內容
    /// </summary>
        ...
        while (true) 
        {
           float fadeSpeed = ((hurryUp ? charactersPerCycle * 5 : charactersPerCycle) * speed)*4f;
            for (int i = minRange; i< maxRange; i++) 
            {
                ...
                Debug.Log("maxranage ="  + maxRange);
                Debug.Log("minranage =" + minRange);
